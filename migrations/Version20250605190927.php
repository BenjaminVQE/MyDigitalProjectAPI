 ...
 */
final class Version20250605190927 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE order_article (id INT AUTO_INCREMENT NOT NULL, article_id INT NOT NULL, order_id INT NOT NULL, quantity INT NOT NULL, INDEX IDX_F440A72D7294869C (article_id), INDEX IDX_F440A72D8D9F6D38 (order_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
